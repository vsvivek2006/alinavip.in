...
export const categories: Category[] = [
  {
    ...
    keyHighlights: [
      { title: 'Authentic European Elegance', desc: 'Statuesque Slavic models with radiant skin, natural charm, and sophisticated styling.' },
      { title: 'Bilingual & Cultured', desc: 'Fluent in English and Russian, comfortable accompanying clients in corporate or social settings.' },
      { title: '5-Star Suite Specialists', desc: 'Accustomed to luxury hospitality protocols across DLF Cyber City, Golf Course Road, and Aerocity.' },
      { title: 'Total Privacy Guarantee', desc: 'Zero record retention and discreet executive arrival with no branding or public traces.' },
    ],
    occasions: [
      'Candlelit dinner dates at CyberHub and Horizon Plaza fine dining venues',
      'VIP lounge hosting and high-end cocktail parties across Gurgaon',
      'Private 5-star hotel suite unwinding after demanding corporate meetings',
      'Weekend leisure retreats to luxury resorts in NCR and neighbouring getaways',
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer: 'Average outcall dispatch to central Gurgaon 5-star hotels (The Leela, Trident, Oberoi, Westin) takes 25 to 35 minutes. Our concierge coordinates swift, discreet private transport.',
      },
      {
        question: 'What is the booking protocol for Russian call girls?',
        answer: 'Contact our private booking desk via WhatsApp or direct phone (+91-9996265679). Share your location and preferred schedule. We confirm availability immediately with zero advance payment required.',
      },
      {
  ...
  },
  {
    ...
    description: 'Our elite VIP call girls in Gurgaon provide an uncompromised standard of luxury companionship. Characterized by striking poise, intellect, and worldly etiquette, they accompany distinguished gentlemen to private suite retreats and prestigious social gatherings.',
    icon: 'Star',
    h1Title: 'VIP Call Girls in Gurgaon',
    subheading: 'Top-Tier Celebrity & Executive Escorts Curated for High-Net-Worth Individuals',
    longDescription: [
      'ALINA VIP India represents the gold standard in premium luxury companionship with our VIP call girls in Gurgaon. Handpicked from top fashion, aviation, and corporate spheres, these distinguished companions cater exclusively to high-net-worth individuals, business tycoons, and international travelers.',
    ...
    keyHighlights: [
      { title: 'Rarified Roster', desc: 'Curated selection of high-society models, luxury influencers, and corporate professionals.' },
      { title: 'Executive Polish', desc: 'Worldly conversationalists with refined manners suitable for top-tier social circles.' },
      { title: 'Rapid NCR Outcall', desc: 'Prompt arrival at DLF Phases 1-5, Golf Course Extension, Sohna Road, and Aerocity.' },
      { title: 'Bespoke Itineraries', desc: 'Flexible scheduling for multi-day business conferences, gala dinners, or private vacations.' },
    ],
    occasions: [
      'High-profile business networking and corporate celebration dinners',
      'Exclusive private gatherings and luxury yacht or villa parties',
      'Executive hotel suite unwinding with attentive, sensual companionship',
      'VIP travel and weekend escapes across luxury destinations',
    ],
    faqs: [
      {
        question: 'What distinguishes VIP call girls from regular escorts?',
        answer: 'Our VIP call girls feature higher educational pedigrees, media/fashion backgrounds, superior social etiquette, and absolute discretion tailored for high-profile gentlemen.',
      },
      {
        question: 'How do you ensure confidentiality for VIP clients in Gurgaon?',
        answer: 'We enforce strict zero-trace privacy protocols. All booking messages are encrypted, phone numbers are never stored in databases, and arrival is coordinated through private executive cars.',
      },
      {
        question: 'Can I arrange multi-day companionship with a VIP escort?',
        answer: 'Yes. We accommodate extended engagements, including weekend business trips, vacation accompaniment, and private retreats across India and abroad.',
      },
      {
  ...
  },
  {
    ...
    occasions: [
      'Corporate conferences and networking banquets in Cyber City',
      'Private boardroom dinners and celebratory business achievements',
      'Art gallery openings, theatre performances, and cultural evenings',
      'Relaxed luxury dining at top Gurgaon rooftop restaurants',
    ],
    faqs: [
      {
        question: 'What backgrounds do high-profile call girls come from?',
        answer: 'Our high-profile companions include corporate professionals, former media anchors, hospitality executives, and university graduates who provide refined companionship part-time.',
      },
      {
      ...
      {
        question: 'Are photos of high-profile girls real?',
        answer: 'Yes, 100%. While some profiles use face-veil options to protect their day careers, verified untouched photos are shared confidentially via private WhatsApp.',
      },
    ],
  },
  {
    ...
    keyHighlights: [
      { title: 'Strict Age Verification (21+)', desc: 'Every profile is legally verified with government-issued photo ID.' },
      { title: 'Natural, Fresh Glamour', desc: 'Girl-next-door charm, minimal artificial makeup, and bubbly enthusiasm.' },
      { title: 'Carefree & Playful', desc: 'Warm company that makes every meeting feel like an authentic romantic date.' },
      { title: 'Flexible Outcall Scheduling', desc: 'Available for afternoon tea, late-night hotel visits, or weekend getaways.' },
    ],
    occasions: [
      'Casual cafe hangouts and shopping companionship at luxury malls',
      'Cinema dates, drive-in movies, and weekend road trips',
      'Lighthearted hotel suite unwinding after long corporate schedules',
      'Spontaneous late-night dinners and romantic dessert runs',
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer: 'Yes. College companions are very popular for day outings, casual lunches, coffee dates, and relaxed afternoon companionship across Gurgaon.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Yes, completely. Our zero-advance policy and confidential dispatch ensure that no third party ever knows about your private rendezvous.',
      },
    ],
  },
  {
    ...
    shortDescription: 'Empowered, self-managed escorts offering dedicated, private, and tailored companionship.',
    ...
    subheading: 'Direct, Autonomous & Highly Personalized Luxury Companionship',
    longDescription: [
    ...
    keyHighlights: [
      { title: 'Authentic Chemistry', desc: 'Unscripted, genuine affection focused completely on your personal desires.' },
      { title: 'Flexible Scheduling', desc: 'Easy accommodation for extended hours, overnight stays, and travel itineraries.' },
      { title: 'Direct Understanding', desc: 'Personalized attention to your unique preferences without rigid protocols.' },
      { title: 'Verified Profiles', desc: 'Every independent escort profile is screened for photo authenticity and health safety.' },
    ],
    occasions: [
      'Intimate, unhurried private evenings at home or hotel suites',
      'Overnight companionship for restorative comfort and relaxation',
      'Weekend getaways and resort vacations requiring customized itineraries',
      'Bespoke dinner dates where mutual chemistry takes center stage',
    ],
    faqs: [
      {
        question: 'Why choose an independent call girl over agency escorts?',
        answer: 'Independent call girls offer a more personalized, intimate vibe with fewer commercial constraints, giving you genuine warmth, flexibility, and direct rapport.',
      },
      {
        question: 'How are independent escorts verified on ALINA VIP?',
        answer: 'We meet each independent model in person, authenticate her photo gallery, and verify government credentials so clients enjoy safe, genuine bookings.',
      },
      {
        question: 'Do independent escorts provide hotel outcall services in Gurgaon?',
        answer: 'Yes. They provide prompt outcalls to all 4-star and 5-star hotels, luxury farmhouses, and private apartments across Gurgaon and Delhi NCR.',
      },
      {
  ...
  },
  {
    ...
    shortDescription: 'Well-travelled aviation professionals renowned for immaculate grooming and global poise.',
    ...
    keyHighlights: [
      { title: 'Aviation Grooming Standards', desc: 'Impeccable makeup, statuesque posture, and elegant dress sense.' },
      { title: 'Trained in Five-Star Hospitality', desc: 'Attentive, courteous, and intuitive understanding of guest comfort.' },
      { title: 'Aerocity & DLF Rapid Dispatch', desc: 'Positioned close to airport corridors for 20-minute hotel arrival.' },
      { title: 'Well-Travelled & Cosmopolitan', desc: 'Fluent in English with engaging stories and a broad cultural worldview.' },
    ],
    occasions: [
      'Transit hotel stays and layovers in Aerocity and Mahipalpur',
      'Business executive outcalls in DLF Cyber City and Golf Course Road',
      'VIP dinner dates requiring refined, globally minded companionship',
      'Discreet weekend getaways across luxury domestic destinations',
    ],
    faqs: [
      {
        question: 'Are your air hostess escorts real cabin crew members?',
        answer: 'Yes. Our air hostess category features active and former cabin crew members from domestic and international airlines who provide exclusive escort services during their layovers.',
      },
      {
  ...
  },
  {
    ...
    longDescription: [
      'Turn heads wherever you go with our collection of verified model escorts in Gurgaon. Featuring active runway models, commercial photoshoot faces, and fashion influencers, this category offers breathtaking visual allure and magnetic confidence.',
      'These models possess statuesque proportions, radiant skin, and effortless style. Whether you are entering an exclusive rooftop club in Sector 29, walking the red carpet at a private event, or enjoying private moments in a luxury suite, they bring an aura of star power.',
      'Every model profile on ALINA VIP India represents real, current photographs verified by our management team. Book with complete confidence knowing you will meet a genuine runway-calibre beauty.',
    ],
    keyHighlights: [
      { title: 'Ramp & Editorial Standard', desc: 'Breathtaking beauty, tall figures, and photogenic facial symmetry.' },
      { title: 'High-Fashion Wardrobe', desc: 'Impeccable sartorial taste tailored for VIP clubs and gala events.' },
      { title: 'Effortless Confidence', desc: 'Commanding presence that enhances your status at any gathering.' },
      { title: 'Verified Untouched Photos', desc: 'Real photos matched and authenticated in-person by our team.' },
    ],
    occasions: [
    ...
    faqs: [
      ...
      },
      {
        ...
        answer: 'Yes. Our models are experienced in attending high-society parties, corporate awards, and luxury celebrations, maintaining impeccable poise throughout.',
      },
      {
        question: 'What is the minimum booking duration for model escorts?',
        answer: 'We offer flexible packages starting from 2-hour dinner dates to full-night engagements and multi-day travel arrangements.',
      },
      {
        question: 'How do I confirm a model escort reservation?',
        answer: 'Call our dedicated booking concierge at +91-9996265679 or send a WhatsApp message with your selected profile code for immediate confirmation.',
      },
    ],
  },
  {
    ...
    subheading: 'Exclusive Screen & Fashion Personalities for Ultra-High-Net-Worth Patrons',
    longDescription: [
      'For patrons who accept only the extraordinary, ALINA VIP India orchestrates private rendezvous with celebrity escorts in Gurgaon. Featuring recognized media personalities, music video stars, and television starlets, this is India’s most exclusive companionship tier.',
    ...
    keyHighlights: [
      ...
      { title: 'Presidential-Grade Privacy', desc: 'Strict non-disclosure protocols and secure executive transport.' },
      { title: 'Bespoke Coordination', desc: 'Customized itineraries tailored to high-profile clients and celebrities.' },
      { title: 'Unsurpassed Glamour', desc: 'An unforgettable encounter with a woman who commands the spotlight.' },
    ],
    occasions: [
      'Private presidential suite stays at The Oberoi, Leela, or Taj',
      'Exclusive farmhouse gatherings in Delhi NCR with high-security perimeters',
      'Private yacht cruises and international luxury getaways',
      'Bespoke milestone celebrations for discerning high-net-worth patrons',
    ],
    faqs: [
      {
        question: 'How are celebrity escort bookings handled?',
        answer: 'Celebrity bookings are coordinated directly by our senior director via encrypted channels. Advance notice of at least 4 to 6 hours is recommended for scheduling.',
      },
      {
        question: 'Is client identity protected during celebrity bookings?',
        answer: 'Yes. We sign non-disclosure agreements upon request and operate under total anonymity. No client data is ever recorded or shared.',
      },
      {
        question: 'Where do celebrity escort rendezvous take place?',
        answer: 'Bookings are strictly outcall to five-star luxury suites, presidential villas, or private high-security estates.',
      },
      {
        question: 'What is the payment procedure for celebrity escorts?',
        answer: 'Transparent pricing is communicated upfront by our senior director. Payment is settled securely without hidden fees.',
      },
    ],
  },
  {
    ...
    occasions: [
      ...
      'Beach holidays in Goa, Maldives, and Andaman islands',
      'International business trips requiring charming evening company',
      'Private yacht charter holidays and mountain resort retreats',
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer: 'The client provides first-class or business travel, hotel accommodations, meals, and the agreed daily companionship fee.',
      },
      {
        question: 'Can I meet the travel escort in Gurgaon before our trip?',
        answer: 'Yes. We recommend scheduling a dinner date or coffee meeting in Gurgaon beforehand to ensure perfect mutual chemistry before departing.',
      },
    ],
  },
  {
    ...
    description: 'Our mature housewife call girls in Gurgaon specialize in genuine warmth, empathetic listening, and unhurried romance. Ideal for discerning clients seeking unpretentious, deeply relaxing companionship in a calm, discreet environment.',
    icon: 'User',
    ...
    keyHighlights: [
      { title: 'Emotional Warmth & Empathy', desc: 'Attentive listeners who understand the pressures of executive life.' },
      { title: 'Sensual, Curvy Beauty', desc: 'Full-figured, mature aesthetics radiating natural sensuality.' },
      { title: 'Unhurried Passion', desc: 'Relaxed pacing focused on mutual comfort, intimacy, and satisfaction.' },
      { title: 'Total Domestic Comfort', desc: 'Ideal for cozy evenings in luxury service apartments and private homes.' },
    ],
    occasions: [
      'Quiet, stress-relieving private evenings at luxury serviced apartments',
      'Unhurried afternoon rendezvous away from the bustle of the city',
      'Heartfelt conversations paired with comforting, affectionate intimacy',
      'Extended overnight stays designed for complete rejuvenation',
    ],
    faqs: [
      {
        question: 'What is the appeal of housewife call girls in Gurgaon?',
        answer: 'Clients choose housewife escorts for their genuine emotional warmth, mature sensuality, unhurried pacing, and empathetic connection that feels authentic and comforting.',
      },
      {
  ...
  },
  {
    ...
    shortDescription: 'Versatile, five-star companions mastering every facet of upscale luxury companionship.',
    ...
    keyHighlights: [
      { title: 'All-Round Five-Star Quality', desc: 'Exquisite balance of physical beauty, intellect, and passionate affection.' },
      { title: 'Versatile Social Grace', desc: 'Equally comfortable at upscale galas, business dinners, or private suites.' },
      { title: '24/7 Rapid Dispatch', desc: 'Quick 20 to 30 minute arrival across all Gurgaon and NCR destinations.' },
      { title: 'No-Advance Booking', desc: 'Settle directly upon arrival with complete privacy and zero hidden fees.' },
    ],
    occasions: [
      'Fine dining and nightlife exploration across Gurgaon hotspots',
      'Corporate hospitality and accompaniment for visiting executives',
      'Romantic hotel suite stays and rejuvenating weekend retreats',
      'Private celebration parties and intimate personal evenings',
    ],
    faqs: [
      {
        question: 'How do I book a premium escort in Gurgaon with ALINA VIP?',
        answer: 'Call our 24/7 concierge at +91-9996265679 or WhatsApp us. Choose your preferred profile and time, and we confirm dispatch within minutes.',
      },
      {
        question: 'Which areas in Gurgaon do premium escorts cover?',
        answer: 'We provide outcalls to Cyber City, Golf Course Road, DLF Phases 1-5, Sohna Road, MG Road, Sector 29, Manesar, and Aerocity.',
      },
      {
      ...
      },
      {
        ...
        answer: 'Yes. Our escorts arrive dressed in elegant, discreet attire that blends effortlessly into the lobbies of The Oberoi, Trident, Leela, Westin, and Taj hotels.',
      },
    ],
  },
];
