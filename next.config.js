...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/category/russian-escorts', destination: '/category/russian-call-girls', permanent: true },
      { source: '/vip-escorts', destination: '/category/vip-call-girls', permanent: true },
      { source: '/category/vip-escorts', destination: '/category/vip-call-girls', permanent: true },
      ...
      { source: '/category/independent-escorts', destination: '/category/independent-girls', permanent: true },
      { source: '/air-hostess-escorts', destination: '/category/air-hostess', permanent: true },
      { source: '/category/air-hostess-escorts', destination: '/category/air-hostess', permanent: true },
      { source: '/hotels/escort-service-near-the-oberoi-gurgaon', destination: '/hotels/escort-service-near-the-oberoi-hotel', permanent: true },
